export const missions = [
  ...
  },
  {
    ...
    task: 'Find all compliance flags that have NOT been resolved (resolved = 0). Return flag_id, transaction_id, flag_type, and severity.',
  ...
  },
  {
    ...
    task: "Combine two lists: transaction_ids of Pending transactions, and account_ids of Open compliance reviews. Label each with a source column ('transaction' or 'review'). Return source and id.",
  ...
  },
  {
    ...
    task: 'Find clients who have accounts linked to any compliance flag. Return client_id and full_name.',
  ...
  {
    id: 11,
    title: 'CTE — Recent High-Risk Transactions',
    difficulty: 'Intermediate',
    scenario: 'Suspicious Activity Detection',
    concepts: ['WITH', 'CTE', 'WHERE'],
    task: "Use a CTE named recent_flags to get all compliance flags created in 2026. Then return the flag_id, transaction_id, and flag_type from that CTE.",
  ...
  },
  {
    ...
    task: 'Calculate a running total of transaction amounts per account, ordered by transaction_date. Return account_id, transaction_id, transaction_date, amount, and running_total.',
  ...
  },
  {
    ...
    task: "Rank advisors by the number of high-risk clients they manage (risk_level = 'High'). Return advisor_id, advisor_name, high_risk_count, and risk_rank.",
  ...
  },
  {
    ...
    task: 'Find pairs of transactions on the same account with the same amount on different dates. Return t1.transaction_id as txn1, t2.transaction_id as txn2, t1.account_id, and t1.amount.',
  ...
  },
  {
    ...
    task: 'Use a recursive CTE to generate a numbered list of all regulatory_updates, starting from the row with the lowest update_id. Return level, update_id, regulator, and topic.',
  ...
  },
  {
    ...
    task: 'Find transactions where the amount is above the average amount for that same account. Return transaction_id, account_id, and amount.',
  ...
  },
  {
    ...
    task: "Build a full compliance audit report. For each advisor, show: advisor_id, advisor_name, total_clients, high_risk_clients (risk_level='High'), open_reviews, and a risk_tier (CASE: open_reviews > 3 = 'Critical', > 1 = 'Elevated', else 'Normal'). Only include advisors with at least 1 open review. Order by open_reviews DESC.",
