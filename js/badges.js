export const BADGE_DEFS = [
  ...
  { id: 'halfway',     icon: '⚡', label: 'Halfway There',      desc: 'Reached the halfway point of your run.' },
...
export function checkBadges(state, queueLength) {
  ...
  if (done === Math.ceil(queueLength / 2) && !state.earnedBadges.has('halfway'))  newly.push('halfway');
